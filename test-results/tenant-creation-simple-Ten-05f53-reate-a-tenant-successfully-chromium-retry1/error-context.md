      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e16]:
          - link "Next.js 15.5.3 (stale) Webpack" [ref=e17] [cursor=pointer]:
            ...
            - generic "There is a newer version (15.5.4) available, upgrade recommended!" [ref=e20] [cursor=pointer]: Next.js 15.5.3 (stale)
        ...
        - dialog "Runtime Error" [ref=e23]:
          - generic [ref=e26]:
            - generic [ref=e27]:
              ...
              - paragraph [ref=e48]: "ENOENT: no such file or directory, open '/Users/alvaro/Projects/VittaMedApp/.next/server/pages/_document.js'"
            - generic [ref=e51]:
              - paragraph [ref=e52]:
                - text: Call Stack
                - generic [ref=e53]: "35"
              - button "Show 35 ignore-listed frame(s)" [ref=e54] [cursor=pointer]:
